...
class Student {
public:
    // geen zelfgemaakte copy-constructor aanwezig; enkel de standaard copy-constructor
    // deze kopieert geen dynamisch aangemaakt geheugen
    // m.a.w. aanpassingen op s3 hebben OOK een effect op s1 nadat je Student s3(s1); doet // copy-constructor
...
private:
    ...
    string naam;
    int aantalPunten;
    int* punten; // dynamisch aangemaakt geheugen
};
...
20021923 Jef Bracke     12  10  16  11   // punt 1 is hier ook 10 geworden!! punten is dynamisch aangemaakt geheugen
*/
